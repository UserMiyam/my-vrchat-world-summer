...
namespace UnlitWF
{
    static class WFMenu
    {
        ...
        public const string GAMEOBJECT_AVATARMENU = PATH_GAMEOBJECT + "UnlitWF Shader/WFアバターメニュー追加";
#else
        ...
        public const string GAMEOBJECT_AVATARMENU = PATH_GAMEOBJECT + "UnlitWF Shader/Add WF AvatarMenu";
#endif
