...
namespace UnlitWF
{
    ...
    static class WFShaderDictionary
    {
        ...
        public static readonly Dictionary<string, string> ShaderFuncHelpUrl = new Dictionary<string, string>()
        {
            ...
            { "LBE", HELP_URL_UNTOON + "#LightBakeEffects" },
            ...
            { "WA2", HELP_URL_WATER + "#SurfaceWaving" },
            { "WA3", HELP_URL_WATER + "#SurfaceWaving" },
            { "WAD", HELP_URL_WATER + "#SurfaceDistanceFade" },
            { "WAS", HELP_URL_WATER + "#SurfaceSpecular" },
            { "WAM", HELP_URL_WATER + "#SurfaceReflection" },
            { "Water/FX/Caustics/Base", HELP_URL_WATER + "#CausticsBase" },
            { "Water/FX/Caustics/Water", HELP_URL_WATER + "#CausticsWater" },
            { "Water/FX/DepthFog/Base", HELP_URL_WATER + "#DepthFogBase" },
            { "Water/FX/DepthFog/Water", HELP_URL_WATER + "#DepthFogBase" },
            { "Water/FX/Sun/Base", HELP_URL_WATER + "#SunReflectionBase" },
            { "Water/FX/Sun/Sun Reflection", HELP_URL_WATER + "#SunReflectionBase" },
            { "Water/FX/Lamp/Base", HELP_URL_WATER + "#SunReflectionBase" },
            { "Water/FX/Lamp/Lamp Reflection", HELP_URL_WATER + "#SunReflectionBase" },
        };
        ...
        public static readonly List<WFI18NTranslation> LangEnToKo = new List<WFI18NTranslation>() {
            // HeaderTitle
            new WFI18NTranslation("3ch Color Mask", "3채널 컬러 마스크"),
            new WFI18NTranslation("Ambient Occlusion", "AO 맵과 라이트 맵"),
            new WFI18NTranslation("Main Texture 2nd", "메인 텍스처 2nd"),
            new WFI18NTranslation("BackFace Texture", "뒷면 텍스처"),
            new WFI18NTranslation("Base", "기본 설정"),
            new WFI18NTranslation("ClearCoat", "클리어 코트"),
            new WFI18NTranslation("Gradient Map", "그라디언트 맵"),
            new WFI18NTranslation("Color Change", "색상 변경"),
            new WFI18NTranslation("Detail NormalMap", "디테일 노멀맵"),
            new WFI18NTranslation("Distance Fade", "거리 페이드"),
            new WFI18NTranslation("Dissolve", "디졸브"),
            new WFI18NTranslation("Emission", "에미션"),
            new WFI18NTranslation("Fake Fur", "퍼"),
            new WFI18NTranslation("Fog", "포그"),
            new WFI18NTranslation("FrostedGlass", "유리"),
            new WFI18NTranslation("Gem Background", "보석(뒷면)"),
            new WFI18NTranslation("Gem Flake", "보석(플레이크)"),
            new WFI18NTranslation("Gem Reflection", "보석(반사)"),
            new WFI18NTranslation("Gem Surface", "보석(표면)"),
            new WFI18NTranslation("Ghost Transparent", "고스트 투명"),
            new WFI18NTranslation("Grass Wave", "풀의 흔들림"),
            new WFI18NTranslation("Grass", "풀"),
            new WFI18NTranslation("Lame", "라메"),
            new WFI18NTranslation("Light Bake Effects", "라이트 베이크 효과"),
            new WFI18NTranslation("Light Matcap 2", "매트 캡2"),
            new WFI18NTranslation("Light Matcap 3", "매트 캡3"),
            new WFI18NTranslation("Light Matcap 4", "매트 캡4"),
            new WFI18NTranslation("Light Matcap 5", "매트캡5"),
            new WFI18NTranslation("Light Matcap 6", "매트캡6"),
            new WFI18NTranslation("Light Matcap 7", "매트캡7"),
            new WFI18NTranslation("Light Matcap 8", "매트캡 8"),
            new WFI18NTranslation("Light Matcap", "매트캡"),
            new WFI18NTranslation("Lit Advance", "라이트 설정(확장)"),
            new WFI18NTranslation("Lit", "라이트 설정"),
            new WFI18NTranslation("Material Options", "머티리얼 설정"),
            new WFI18NTranslation("Metallic", "메탈릭"),
            new WFI18NTranslation("Mirror Control", "미러 제어"),
            new WFI18NTranslation("NormalMap", "노멀 맵"),
            new WFI18NTranslation("Outline", "아웃라인"),
            new WFI18NTranslation("Overlay Texture", "오버레이 텍스처"),
            new WFI18NTranslation("Reflection", "반사(리플렉션)"),
            new WFI18NTranslation("Refraction", "굴절"),
            new WFI18NTranslation("RimLight", "림라이트"),
            new WFI18NTranslation("RimShadow", "림 섀도우"),
            new WFI18NTranslation("BackLight", "역광 라이트"),
            new WFI18NTranslation("Specular", "광택(스페큘러)"),
            new WFI18NTranslation("Stencil Mask", "스텐실"),
            new WFI18NTranslation("Tessellation", "세분화"),
            new WFI18NTranslation("ToonShade", "툰 셰이딩"),
            new WFI18NTranslation("Transparent Alpha", "투명 알파"),
            new WFI18NTranslation("Utility", "유틸리티"),
            new WFI18NTranslation("Water", "물"),
            new WFI18NTranslation("Waving 1", "파면 생성 1"),
            new WFI18NTranslation("Waving 2", "파면 생성 2"),
            new WFI18NTranslation("Waving 3", "파면 생성 3"),
            new WFI18NTranslation("Particle System", "파티클"),
            // Base
            ...
            new WFI18NTranslation("Speed", "스피드"),
            new WFI18NTranslation("Power", "강도"),
            new WFI18NTranslation("Roughen", "거칠기"),
            new WFI18NTranslation("Finer", "잘게 나누기"),
            new WFI18NTranslation("Tint Color", "색상 조정"),
            new WFI18NTranslation("Fade Distance", "페이드 거리"),
            new WFI18NTranslation("Fade Distance (Near)", "페이드 거리 (가까워짐)"),
            new WFI18NTranslation("Fade Distance (Far)", "페이드 거리 (멀어짐)"),
            new WFI18NTranslation("FadeOut Distance", "페이드 아웃 거리"),
            new WFI18NTranslation("FadeOut Distance (Near)", "페이드 아웃 거리(가까워짐)"),
            new WFI18NTranslation("FadeOut Distance (Far)", "페이드 아웃 거리(멀어짐)"),
            new WFI18NTranslation("Shadow Power", "그림자 강도"),
            new WFI18NTranslation("Preview", "미리 보기"),
            new WFI18NTranslation("Save", "저장"),
            new WFI18NTranslation("Gamma", "감마"),
            new WFI18NTranslation("Create GradationMap Texture", "그라데이션 맵용 텍스처 생성"),
            // Lit
            ...
            new WFI18NTranslation("Shadow Cutoff Threshold", "그림자 컷오프 임계값"),
            new WFI18NTranslation("Use CameraDepthTexture", "CameraDepthTexture 사용"),
            new WFI18NTranslation("Light Direction Override", "조명 방향 재정의"),
            // Alpha
            new WFI18NTranslation("AL", "Alpha Source", "알파 소스"),
            new WFI18NTranslation("AL", "Alpha Mask Texture", "알파 텍스처"),
            new WFI18NTranslation("AL", "Mask Mode", "마스크 모드"),
            ...
            // MainTexture2nd
            new WFI18NTranslation("TX2", "Main Texture 2nd", "메인 텍스처 2nd"),
            new WFI18NTranslation("TX2", "Color 2nd", "머티리얼 컬러 2nd"),
            // BackFace Texture
            ...
            new WFI18NTranslation("NM", "Use DirectX NormalMap", "DirectX의 노멀맵 사용"),
            // Normal 2nd
            new WFI18NTranslation("NS", "2nd Normal Blend", "2nd 노멀 맵 블렌드 유형"),
            new WFI18NTranslation("NS", "2nd Normal UV Type", "2nd 노멀 맵 UV 유형"),
            new WFI18NTranslation("NS", "2nd NormalMap Texture", "2nd 노멀맵 텍스처"),
            new WFI18NTranslation("NS", "2nd Bump Scale", "2nd 범프 스케일"),
            new WFI18NTranslation("NS", "2nd NormalMap Mask Texture", "2nd 노멀 마스크"),
            new WFI18NTranslation("NS", "2nd NormalMap Mask Texture (R)", "2nd 노멀 마스크 (R)"),
            // Metallic
            ...
            new WFI18NTranslation("TS", "1st Feather", "1 그림자 경계 흐림 강도"),
            new WFI18NTranslation("TS", "2nd Feather", "2 그림자 경계 흐림 강도"),
            new WFI18NTranslation("TS", "3rd Feather", "3 그림자 경계 흐림 강도"),
            new WFI18NTranslation("TS", "Mask Type", "마스크 종류"),
            ...
            new WFI18NTranslation("TS", "SDF Texture", "SDF 텍스처"),
            new WFI18NTranslation("TS", "SDF Texture (RG)", "SDF 텍스처 (RG)"),
            ...
            new WFI18NTranslation("TR", "Width", "폭").AddTag("TM", "TBL"),
            new WFI18NTranslation("TR", "Width Top", "폭(위)").AddTag("TM"),
            new WFI18NTranslation("TR", "Width Side", "폭(가로)").AddTag("TM"),
            new WFI18NTranslation("TR", "Width Bottom", "폭(아래)").AddTag("TM"),
            new WFI18NTranslation("TR", "Feather", "흐림값").AddTag("TM", "TBL"),
            new WFI18NTranslation("TR", "Exponent", "보케 지수").AddTag("TM"),
            new WFI18NTranslation("TR", "Tint Base Color", "베이스 컬러를 림 라이트 색상에 혼합"),
            new WFI18NTranslation("TM", "Rim Color", "림 섀도우 색상"),
            new WFI18NTranslation("TBL", "Back Light Color", "백라이트 색상"),
            new WFI18NTranslation("TBL", "Angle of Visibility", "가시 범위"),
            new WFI18NTranslation("TBL", "Tint Base Color", "베이스 컬러를 백라이트 색상에 곱하기"),
            new WFI18NTranslation("TBL", "Camera Correction", "카메라 보정"),
            // Overlay Texture
            ...
            new WFI18NTranslation("OVL", "Out of UV Mode", "UV 외부 처리"),
            // EmissiveScroll
            new WFI18NTranslation("ES", "Emission", "Emission 텍스처"),
            new WFI18NTranslation("ES", "Emission Texture", "Emission 텍스처"),
            new WFI18NTranslation("ES", "Tint Base Color", "베이스 컬러를 발광 색상에 곱하기"),
            new WFI18NTranslation("ES", "Enable EmissiveScroll", "발광 스크롤 사용"),
            new WFI18NTranslation("ES", "Wave Type", "웨이브 타입"),
            new WFI18NTranslation("ES", "Wave Grad Tex", "파형 그라데이션 텍스처"),
            ...
            new WFI18NTranslation("ES", "Enable AudioLink", "오디오 링크 사용"),
            new WFI18NTranslation("ES", "Emission Multiplier", "방출 배율"),
            new WFI18NTranslation("ES", "Emission Multiplier (Min)", "방출 배율 (최소)"),
            new WFI18NTranslation("ES", "Emission Multiplier (Max)", "방출 배율 (최대)"),
            new WFI18NTranslation("ES", "Band", "대역"),
            new WFI18NTranslation("ES", "Slope", "경사"),
            new WFI18NTranslation("ES", "Threshold", "역치"),
            new WFI18NTranslation("ES", "Threshold (Min)", "역치 (최소)"),
            new WFI18NTranslation("ES", "Threshold (Max)", "역치 (최대)"),
            new WFI18NTranslation("ES", "Dont Emit when AudioLink is disabled", "오디오 링크 비활성화 시 발광하지 않음"),
            new WFI18NTranslation("ES", "Delay Direction", "딜레이 방향"),
            new WFI18NTranslation("ES", "Delay Control Texture (R)", "딜레이 제어 텍스처 (R)"),
            new WFI18NTranslation("ES", "Delay Reverse", "딜레이 반전"),
            new WFI18NTranslation("ES", "Delay Length", "딜레이 길이"),
            // Outline
            ...
            new WFI18NTranslation("DFD", "Color Texture", "색 텍스처"),
            new WFI18NTranslation("DFD", "Fade Distance", "페이드 거리"),
            ...
            // Dissolve
            new WFI18NTranslation("DSV", "Dissolve", "디졸브"),
            new WFI18NTranslation("DSV", "Invert", "반전"),
            new WFI18NTranslation("DSV", "Control Texture (R)", "제어 텍스처 (R)"),
            new WFI18NTranslation("DSV", "Spark Color", "스파크 색상"),
            new WFI18NTranslation("DSV", "Spark Width", "스파크 너비"),
            // Toon Fog
            ...
            new WFI18NTranslation("Cancel Near Clipping", "카메라의 니어 클리핑 무시"),
            new WFI18NTranslation("Use VRC LightVolumes", "VRC LightVolumes 사용"),
            // Light Bake Effects
            ...
            // Gem Surface
            new WFI18NTranslation("Transparency (front)", "투명도 (표면)"),
            new WFI18NTranslation("Transparency (back)", "투명도 (뒷면)"),
            // Gem Background
            new WFI18NTranslation("GMB", "Background Color", "배경 색상 (뒷면 색상)"),
            new WFI18NTranslation("GMB", "Background CullMode", "커링 모드 (뒷면)"),
            // Gem Reflection
            ...
            new WFI18NTranslation("FUR", "Length Mask Texture", "길이 마스크"),
            new WFI18NTranslation("FUR", "Alpha Mask Texture", "알파 마스크"),
            // Refraction
            new WFI18NTranslation("CRF", "Refractive Index", "한국어"),
            new WFI18NTranslation("CRF", "Correct Refraction to exclude the foreground", "굴절 보정(앞쪽 메쉬를 비추지 않음)"),
            // Frosted Glass
            new WFI18NTranslation("CGL", "Blur", "블러"),
            new WFI18NTranslation("CGL", "Blur Min", "블러(하한)"),
            new WFI18NTranslation("CGL", "Blur Mode", "블러 모드"),
            new WFI18NTranslation("CGL", "Blur Random", "블러 랜덤화"),
            new WFI18NTranslation("CGL", "Correct Blur to exclude the foreground", "블러 보정(앞쪽 메쉬를 비추지 않음)"),
            // Grass
            new WFI18NTranslation("GRS", "Height Type", "높이 지정 유형"),
            new WFI18NTranslation("GRS", "Ground Y coordinate", "지면 Y 좌표"),
            new WFI18NTranslation("GRS", "Height scale", "높이 스케일"),
            new WFI18NTranslation("GRS", "Height UV Type", "높이 지정 UV 유형"),
            new WFI18NTranslation("GRS", "Height Mask Tex", "높이 지정 마스크 텍스처"),
            new WFI18NTranslation("GRS", "UV Factor", "UV 계수"),
            new WFI18NTranslation("GRS", "Color Factor", "컬러 계수"),
            new WFI18NTranslation("GRS", "Tint Color Top", "색상 조정(선단)"),
            new WFI18NTranslation("GRS", "Tint Color Bottom", "색상 조정(뿌리)"),
            new WFI18NTranslation("GRS", "Erase Side", "측면 숨기기"),
            // GrassWave
            new WFI18NTranslation("GRW", "Wave Speed", "파도 속도"),
            new WFI18NTranslation("GRW", "Wave Amplitude", "파도 진폭"),
            new WFI18NTranslation("GRW", "Wave Exponent", "지수"),
            new WFI18NTranslation("GRW", "Wave Offset", "오프셋"),
            new WFI18NTranslation("GRW", "Wind Vector", "바람 벡터"),
            // Water
            new WFI18NTranslation("Water Color", "수면 색상"),
            new WFI18NTranslation("Water Color 2", "수면 색상 2"),
            new WFI18NTranslation("Caustics Color", "코스티크스 색상"),
            new WFI18NTranslation("Fog Color", "포그 색상"),
            new WFI18NTranslation("WA", "Water Level (World Y Coord)", "수면 높이 (월드 Y 좌표)"),
            new WFI18NTranslation("WA", "Hide Caustics above water", "수면 위에서는 코스틱스 숨기기"),
            new WFI18NTranslation("WA", "Water Transparency", "물 투명도"),
            new WFI18NTranslation("WA1", "Wave NormalMap", "파면 노멀맵").AddTag("WA2", "WA3"),
            new WFI18NTranslation("WA1", "Wave Normal Scale", "요철 스케일").AddTag("WA2", "WA3"),
            new WFI18NTranslation("WA1", "Wave HeightMap", "파면 높이맵").AddTag("WA2", "WA3"),
            new WFI18NTranslation("WA1", "Caustics Tex", "코스티크스 텍스처").AddTag("WA2", "WA3"),
            new WFI18NTranslation("WAM", "Smoothness", "매끄러움"),
            new WFI18NTranslation("WAM", "2nd CubeMap Blend", "2차 큐브맵 블렌드"),
            new WFI18NTranslation("WAM", "Cube Map", "큐브맵"),
            new WFI18NTranslation("WAS", "Specular Power", "스페큘러 강도"),
            new WFI18NTranslation("WAS", "Specular Color", "스페큘러 색상"),
            new WFI18NTranslation("WAS", "Specular Smoothness", "스페큘러 부드러움"),
            new WFI18NTranslation("WAS", "Specular 2 Power", "스페큘러 강도 2"),
            new WFI18NTranslation("WAS", "Specular 2 Color", "스페큘러 색상 2"),
            new WFI18NTranslation("WAS", "Specular 2 Smoothness", "반사 2 부드러움"),
            new WFI18NTranslation("WAR", "Sun Azimuth", "태양 방위각"),
            new WFI18NTranslation("WAR", "Sun Altitude", "태양 고도"),
            new WFI18NTranslation("WAR", "Size", "크기"),
            new WFI18NTranslation("WAR", "Base Pos", "위치"),
            new WFI18NTranslation("WAR", "Hide Back", "뒷면 숨기기"),
            // Particle
            new WFI18NTranslation("PA", "Vertex Color Blend Mode", "정점 색상 혼합 모드"),
            ...
            new WFI18NTranslation("Swap value/Light Matcap", "교체/매트캡"),
            new WFI18NTranslation("Swap value/Light Matcap 2", "교체/매트캡 2"),
            new WFI18NTranslation("Swap value/Light Matcap 3", "교체/매트캡 3"),
            new WFI18NTranslation("Swap value/Light Matcap 4", "교체/매트캡 4"),
            new WFI18NTranslation("Swap value/Light Matcap 5", "교체/매트캡 5"),
            new WFI18NTranslation("Swap value/Light Matcap 6", "교체/매트캡 6"),
            new WFI18NTranslation("Swap value/Light Matcap 7", "교체/매트캡 7"),
            new WFI18NTranslation("Swap value/Light Matcap 8", "교체/매트캡 8"),

            // 열거형
            new WFI18NTranslation("UnlitWF.BlendModeOVL.ALPHA", "알파 합성"),
            new WFI18NTranslation("UnlitWF.BlendModeOVL.ADD", "가산"),
            new WFI18NTranslation("UnlitWF.BlendModeOVL.MUL", "곱셈"),
            new WFI18NTranslation("UnlitWF.BlendModeOVL.ADD_AND_SUB", "가산・감산"),
            new WFI18NTranslation("UnlitWF.BlendModeOVL.SCREEN", "스크린"),
            new WFI18NTranslation("UnlitWF.BlendModeOVL.OVERLAY", "오버레이"),
            new WFI18NTranslation("UnlitWF.BlendModeOVL.HARD_LIGHT", "하드 라이트"),
            new WFI18NTranslation("UnlitWF.BlendModeHL.ADD_AND_SUB", "가산・감산"),
            new WFI18NTranslation("UnlitWF.BlendModeHL.ADD", "가산"),
            new WFI18NTranslation("UnlitWF.BlendModeHL.MUL", "승산"),
            new WFI18NTranslation("UnlitWF.BlendModeES.ADD", "가산"),
            new WFI18NTranslation("UnlitWF.BlendModeES.ALPHA", "알파 합성"),
            new WFI18NTranslation("UnlitWF.BlendModeES.LEGACY_ALPHA", "알파 합성(구 타입)"),
            new WFI18NTranslation("UnlitWF.BlendModeTR.ADD", "가산"),
            new WFI18NTranslation("UnlitWF.BlendModeTR.ALPHA", "알파 합성"),
            new WFI18NTranslation("UnlitWF.BlendModeTR.ADD_AND_SUB", "가산・감산"),
            new WFI18NTranslation("UnlitWF.BlendModeTR.MUL", "승산"),
            new WFI18NTranslation("UnlitWF.BlendModeVC.MUL", "곱셈"),
            new WFI18NTranslation("UnlitWF.BlendModeVC.ADD", "가산"),
            new WFI18NTranslation("UnlitWF.BlendModeVC.SUB", "감산"),
            new WFI18NTranslation("UnlitWF.SunSourceMode.AUTO", "자동"),
            new WFI18NTranslation("UnlitWF.SunSourceMode.ONLY_DIRECTIONAL_LIT", "방향광만"),
            new WFI18NTranslation("UnlitWF.SunSourceMode.ONLY_POINT_LIT", "포인트 라이트만"),
            new WFI18NTranslation("UnlitWF.SunSourceMode.CUSTOM_WORLD_DIR", "커스텀(월드 방향)"),
            new WFI18NTranslation("UnlitWF.SunSourceMode.CUSTOM_LOCAL_DIR", "커스텀(로컬 방향)"),
            new WFI18NTranslation("UnlitWF.SunSourceMode.CUSTOM_WORLD_POS", "커스텀(월드 좌표)"),
            new WFI18NTranslation("UnlitWF.EmissiveScrollMode.STANDARD", "표준"),
            new WFI18NTranslation("UnlitWF.EmissiveScrollMode.SAWTOOTH", "톱니파"),
            new WFI18NTranslation("UnlitWF.EmissiveScrollMode.SIN_WAVE", "사인파"),
            new WFI18NTranslation("UnlitWF.EmissiveScrollMode.CUSTOM", "사용자 정의"),

            // WFEditorSetting
            new WFI18NTranslation("WFEditorSetting", "This is the current setting used.", "이것은 현재 사용 중인 설정입니다."),
            new WFI18NTranslation("WFEditorSetting", "This is not the setting used now.", "이것은 현재 사용 중인 설정이 아니며, 다른 유효한 설정이 있습니다. "),
            new WFI18NTranslation("WFEditorSetting", "Enable Stripping", "불필요한 코드 제거"),
            new WFI18NTranslation("WFEditorSetting", "Strip Unused Variant", "사용되지 않는 변형 제거"),
            new WFI18NTranslation("WFEditorSetting", "Strip Unused Lod Fade", "사용되지 않는 LOD 크로스페이드 제거"),
            new WFI18NTranslation("WFEditorSetting", "Strip Fallback", "Fallback 제거"),
            new WFI18NTranslation("WFEditorSetting", "Strip Meta Pass", "메타 패스 제거"),
            new WFI18NTranslation("WFEditorSetting", "Validate Scene Materials", "빌드 시 오래된 머티리얼 포함 여부 검사"),
            new WFI18NTranslation("WFEditorSetting", "Cleanup Materials Before Avatar Build", "아바타 빌드 전에 머티리얼 정리"),
            new WFI18NTranslation("WFEditorSetting", "Enable Scan Projects", "셰이더 임포트 시 프로젝트 스캔"),
            new WFI18NTranslation("WFEditorSetting", "Enable Migration When Import", "머티리얼 임포트 시 머티리얼 마이그레이션 활성화"),
            new WFI18NTranslation("WFEditorSetting", "Auto Switch Quest Shader", "퀘스트용 셰이더로 자동 전환"),
            new WFI18NTranslation("WFEditorSetting", "Create New Settings asset", "설정 애셋 파일 새로 만들기"),
            new WFI18NTranslation("WFEditorSetting", "Select current setting asset", "현재 활성화된 설정 파일 선택"),
            ...
            new WFI18NTranslation(WFMessageText.PlzFixQueue, "반투명 머티리얼의 큐가 2500개 이하입니다. \nRenderQueue를 수정하시겠습니까?"),
            new WFI18NTranslation(WFMessageText.PlzFixQueueWithClearBg, "반투명 머티리얼의 큐가 2500개 이하입니다. \n배경 제거 패스가 활성화됩니다."),
            new WFI18NTranslation(WFMessageText.PlzFixDoubleSidedGI, "머티리얼의 DoubleSidedGI가 체크되어 있지 않습니다. \n이 머티리얼은 한 면만 라이트 베이크됩니다. \nDoubleSidedGI를 수정하시겠습니까?"),
            new WFI18NTranslation(WFMessageText.PlzFixParticleVertexStreams, "ParticleSystem의 VertexStreams가 일치하지 않습니다. \nParticleSystem 설정을 변경하시겠습니까?"),
            new WFI18NTranslation(WFMessageText.PlzFixCameraDepthTexture, "머티리얼은 CameraDepthTexture를 사용하도록 설정되어 있지만, 씬에 그림자가 있는 라이트가 없습니다. "),
            new WFI18NTranslation(WFMessageText.MenuCreateDepthLight, "심도 생성 라이트를 씬에 추가합니다"),
            new WFI18NTranslation(WFMessageText.MenuWithoutDepthTex, "CameraDepthTex를 사용하지 않도록 머티리얼을 변경합니다"),
            new WFI18NTranslation(WFMessageText.PlzQuestSupport, "이 머티리얼은 퀘스트 미지원 셰이더를 사용하고 있습니다."),
            new WFI18NTranslation(WFMessageText.PlzDeprecatedFeature, "향후 삭제 예정인 기능이 머티리얼에서 사용되고 있습니다."),
            ...
            new WFI18NTranslation(WFMessageText.PsSdfShadowMask, "SDF 섀도우 마스크 필드에는 몸의 왼쪽에서 비추는 빛을 R 채널에, 몸의 오른쪽에서 비추는 빛을 G 채널에 저장한 그림자 텍스처를 설정하십시오."),
            ...
            new WFI18NTranslation(WFMessageText.PsPreviewTexture, "미리보기 텍스처가 설정되어 있습니다.\n미리보기 텍스처는 저장되지 않습니다."),
            new WFI18NTranslation(WFMessageText.PsCameraDepthTex, "CameraDepthTexture 를 사용하는 설정입니다."),
            ...
            new WFI18NTranslation(WFMessageText.DgDontImportUnityPackage, "패키지는 UPM(VPM) 으로 관리됩니다.\nunitypackage에서 가져오기 대신 VCC 등의 관리 도구를 사용하십시오."),
            new WFI18NTranslation(WFMessageText.DgBakeWarning, "베이크할 수 없는 설정이 머티리얼에 포함되어 있습니다. 계속하시겠습니까?"),
            new WFI18NTranslation(WFMessageText.DgManyMaterialConversion, "여러 개의 머티리얼이 선택되었습니다.\n변환을 계속하시겠습니까?"),
            ...
            new WFI18NTranslation(WFMessageButton.Cleanup, "머티리얼에서 불필요한 데이터 삭제"),
            new WFI18NTranslation(WFMessageButton.ApplyTemplate, "템플릿 적용"),
            new WFI18NTranslation(WFMessageButton.SaveTemplate, "템플릿으로 저장"),
            new WFI18NTranslation(WFMessageButton.BakeMainTexture, "메인 텍스처 베이크"),
            new WFI18NTranslation(WFMessageButton.BakeAndSaveTexture, "베이크 후 텍스처만 저장"),
            new WFI18NTranslation(WFMessageButton.BakeAndUpdateMaterial, "베이크 후 머티리얼 변경"),
            new WFI18NTranslation(WFMessageButton.BakeAndNewMaterial, "베이크 후 머티리얼 새로 저장"),

            // 今は未使用
            new WFI18NTranslation("MT", "MetallicMap Type", "Metallic맵 타입"),
            new WFI18NTranslation("TR", "Assign MainTex to MaskTexture", "MainTex를 마스크에 설정합니다"),
        };
    }
