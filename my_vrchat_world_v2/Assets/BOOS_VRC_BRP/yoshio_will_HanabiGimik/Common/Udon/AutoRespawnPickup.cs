...
namespace yoshio_will.common
{
    ...
    public class AutoRespawnPickup : UdonSharpBehaviour
    {
        ...
        [SerializeField] private Transform OnDropReturnTo;
        [Header("OnUseDown")]
        ...
        public override void OnDrop()
        {
            ...
            UpdateIsInHome();
            if (!_isInHome && OnDropReturnTo)
            {
                transform.position = OnDropReturnTo.position;
                transform.rotation = OnDropReturnTo.rotation;
                if (_rigidBody)
                {
                    _rigidBody.position = OnDropReturnTo.position;
                    _rigidBody.rotation = OnDropReturnTo.rotation;
                    _rigidBody.WakeUp();
                }
            }
        }
        ...
        {
            if (Animator != null) Animator.SetBool(_animPickedUp, false);
            UpdateIsInHome();
        }
